#Ce code a été rédigé avec l'aide de l'IA Deepseek. Il est destiné à être exécuté sur une carte MicroPython équipéed'un module RTC DS3231 et d'un bouton poussoir. 
